...
class GLUEEval():
    ...
    def evaluate(self, glue_results, record_path, perplexity_flag = True, sst_flag = False, mmlu_flag = False, mrpc_flag = False, cola_flag = False, rte_flag = False, nli_flag = False, sentiment_analysis_flag = False, dialogue_flag = False, gen_len = 5):
        if perplexity_flag:
            ...
            if data_dir.exists():
                ...
                raise NotImplementedError("Perplexity evaluation is not supported for local datasets")
